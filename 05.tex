...
\begin{prop}
  ...
  $A_1 \bigcup A_2$, bei $A_1 \bigcap A_2$ yra baigtinio automato kalbos.
  ...
  \begin{proof}
    ...
    $F_{A \bigcup B}$ – visos viršūnės $(q_i,q_j)$, kur $q_i \in F_{A}$
    arba $q_j \in F_{B}$.

    $F_{A \bigcap B}$ – visos viršūnės $(q_i,q_j)$, kur $q_i \in F_{A}$
    ir $q_j \in F_{B}$.
  \end{proof}
\end{prop}
